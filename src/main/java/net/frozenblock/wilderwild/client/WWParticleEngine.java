...
public final class WWParticleEngine {
	...
	public static void init() {
		...
		particleRegistry.register(WWParticleTypes.OAK_LEAVES, WWFallingLeavesParticle.Factory::new);
		particleRegistry.register(WWParticleTypes.SPRUCE_LEAVES, WWFallingLeavesParticle.Factory::new);
		particleRegistry.register(WWParticleTypes.BIRCH_LEAVES, WWFallingLeavesParticle.Factory::new);
		particleRegistry.register(WWParticleTypes.JUNGLE_LEAVES, WWFallingLeavesParticle.Factory::new);
		particleRegistry.register(WWParticleTypes.ACACIA_LEAVES, WWFallingLeavesParticle.Factory::new);
		particleRegistry.register(WWParticleTypes.DARK_OAK_LEAVES, WWFallingLeavesParticle.Factory::new);
		particleRegistry.register(WWParticleTypes.PALE_OAK_LEAVES, WWFallingLeavesParticle.Factory::new);
		particleRegistry.register(WWParticleTypes.MANGROVE_LEAVES, WWFallingLeavesParticle.Factory::new);
